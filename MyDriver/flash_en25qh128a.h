...
extern bool en25qh_read_identification(uint8_t *manufacturer, uint8_t *memory_type, uint8_t *memory_capacity);
extern bool en25qh_write_enable(void);
extern bool en25qh_erase_chip(void);
extern bool en25qh_erase_sector(uint32_t addr);
extern bool en25qh_write_page(uint32_t addr, const uint8_t *buf, uint16_t len);
extern bool en25qh_read_data(uint32_t addr, uint8_t *buf, uint32_t len);
extern bool en25qh_wait_busy(void);
extern bool en25qh_write_data(uint8_t *buf, uint32_t sector, uint32_t count);
